...
func (p *EventPublisher) PublishProcessingEvent(ctx context.Context, eventID string, originalEvent, processedEvent map[string]interface{}, rules []string, status string, duration int64, err error) error {
	event := &ServiceEvent{
		EventID:   eventID,
		Service:   "processing",
